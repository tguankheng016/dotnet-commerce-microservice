...
export class IdentityServiceProxy {
     ...
     * @return OK
     */
    refreshToken(body: RefreshTokenRequest, signal?: AbortSignal): Promise<RefreshTokenResult> {
     ...
     * @return OK
     */
    oAuthAuthenticate(body: OAuthAuthenticateRequest, signal?: AbortSignal): Promise<OAuthAuthenticateResult> {
    ...
    protected processOAuthAuthenticate(response: AxiosResponse): Promise<OAuthAuthenticateResult> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (const k in response.headers) {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<OAuthAuthenticateResult>(result200);
        ...
        return Promise.resolve<OAuthAuthenticateResult>(null as any);
    }
     ...
     * @return OK
     */
    authenticate(body: AuthenticateRequest, signal?: AbortSignal): Promise<AuthenticateResult> {
...
export class RoleServiceProxy {
     ...
     * @return OK
     */
    getRoles(skipCount: number | undefined, maxResultCount: number | undefined, filters: string | undefined, sorting: string | undefined, signal?: AbortSignal): Promise<GetRolesResult> {
...
export class UserServiceProxy {
     ...
     * @return OK
     */
    getUsers(skipCount: number | undefined, maxResultCount: number | undefined, filters: string | undefined, sorting: string | undefined, signal?: AbortSignal): Promise<GetUsersResult> {
